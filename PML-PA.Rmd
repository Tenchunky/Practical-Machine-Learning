...
From the confusion matrix, the model achieves 99.38% accuracy and has an out of sample error (1 - accuracy) of only 0.62%. The model also performed well in sensitivity and specificity for all of the classes and achieved more than 98%.
